...
("Lincoln Financial Field","The Linc","Philadelphia, PA","stadium-02-philly-linc.png","number-02-philly-profile.png",
 ...
 ["🏙️ City: Philly — Liberty Bell (famous crack!), Cheesesteaks","🏟️ Stadium: 69,176 seats, 11K solar panels, net-zero energy","🇺🇸 First US capital 1790 — Independence Hall, Rocky Steps","💨 14 wind turbines + LEED Gold — one of greenest stadiums!","🦅 'Eagle Wings' architecture — iconic Philly skyline","🔥 Fun Fact: The Linc hosted Pope Francis mass in 2015!","⭐ Home to Eagles — one of NFL's loudest stadiums","🌎 11,000 solar panels = enough to power 1,000 homes","🥨 Philly is famous for Soft Pretzels and 'Water Ice'","🏈 Hosted the first-ever Army-Navy game in 1890","🎨 Philly has more outdoor murals than any other city!","🎭 The Avenue of the Arts — heart of Philly's theater scene"],
 ["👕 Vinícius Júnior — 'Vini'","🇧🇷 30 caps, 5 goals for Brazil","⚡ Forward for Real Madrid","🏆 Won Copa América 2019 + UCL 2022","🌟 Scored winning goal in UCL final!","🎯 Samba dribbling — one of world's best","🔥 Joined Real Madrid at 18 for €45M","🌎 Born in São Gonçalo, Brazil","👟 Wears #7 — the legendary Real Madrid jersey number","🧒 Started playing futsal before moving to the grass pitch","🗣️ Runs a charity to help improve education in Brazil","🏆 Scored in two different Champions League finals!"]),
("FedExField","The FedEx Giant","Landover, MD (DC)","stadium-03-dc-fedex.png","number-03-dc-profile.png",
 ...
 ["🏛️ City: DC — White House, Lincoln Memorial, Smithsonian (free!)","🏟️ Stadium: 82,000 seats, near Capitol Hill, huge footprint","🌸 Cherry blossoms — 3,000 trees gifted from Japan","📜 National Mall — 2 miles of American history","🎵 Hosted Rolling Stones, Beyoncé, and major concerts","🔥 Fun Fact: 30,000+ parking spaces — one of NFL's biggest!","⭐ Near Washington Monument — 555 ft tall obelisk","🌎 19 Smithsonian museums — all free admission","🏛️ D.C. has no skyscrapers — buildings can't be too tall!","🌳 Rock Creek Park is 2x larger than NYC's Central Park","📖 Library of Congress — the largest library in the world","⛸️ Sculpture Garden — features an ice rink in the winter"],
 ["👕 Harry Kane — England captain","🏴󠁧󠁢󠁥󠁮󠁧󠁿 91 caps, 62 goals (all-time top scorer)","⚡ Striker for Bayern Munich","🏆 Golden Boot — 2018 World Cup (6 goals)","🌟 3x Premier League Golden Boot winner","🎯 Deadly penalty accuracy — 90%+ conversion","🔥 Scored on Premier League debut at 18","🌎 Born in London, England","🦁 Has won the Premier League Golden Boot 3 times","🐕 Loves his two Labradors, Brady and Wilson","🎯 Scored against every Premier League opponent he faced","🏰 Awarded an MBE by the Queen for services to soccer"]),
("Hard Rock Stadium","Hard Rock Hero","Miami Gardens, FL","stadium-04-miami-hardrock.png","number-04-miami-profile.png",
 ...
 ["🏖️ City: Miami — South Beach, Art Deco, Cuban coffee, 248 sun days","🏟️ Stadium: 65,326 seats, canopy covers 90%, F1 Grand Prix","🎨 Art Deco District — 960+ colorful buildings","🚢 Port of Miami — #1 cruise port in the world","🎵 Latin music capital — salsa, reggaeton, and more","🔥 Fun Fact: Hosts Miami Grand Prix — F1 cars race around it!","⭐ Open-air tropical vibe — corner spires like ship masts","🌎 $500M renovation in 2016 transformed the stadium","☀️ Miami: only place where gators and crocodiles coexist!","🎨 Wynwood Walls — world's largest open-air street art","🏢 Miami has the 3rd tallest skyline in the United States","🌊 Bordered by two National Parks — Everglades & Biscayne"],
 ["👕 Lionel Messi — The GOAT","🇦🇷 180 caps, 106 goals for Argentina","⚡ Forward for Inter Miami CF","🏆 8x Ballon d'Or winner — most ever!","🌟 Won 2022 World Cup with Argentina","🎯 800+ career goals — legendary scorer","🔥 91 goals in 2012 — world record!","🌎 Born in Rosario, Argentina","🇦🇷 Won 44 team trophies — most by any player in history!","🧒 Overcame a growth hormone deficiency as a child","🥘 Favorite food: Milanesa a la Napolitana (Argentine steak)","✍️ Signed first Barcelona contract on a paper napkin!"]),
("Mercedes-Benz Stadium","The Benz","Atlanta, GA","stadium-05-atlanta-benz.png","number-05-atlanta-profile.png",
 ...
 ["🏙️ City: Atlanta — world's busiest airport, Southern hospitality","🏟️ Stadium: 71K+ seats, roof opens like flower in 8 min","🐟 Georgia Aquarium — largest in US (6.3 million gallons)","📺 Halo Board — 360° video screen, largest in NFL","♻️ LEED Platinum — highest green building certification","🔥 Fun Fact: Fan-friendly pricing — $2 hot dogs, $5 beers!","⭐ Retractable roof — 8 'petals' that open in 8 minutes","🌎 Coca-Cola was invented in Atlanta in 1886","🍑 Georgia is the 'Peach State' but top crop is peanuts!","🎡 SkyView Atlanta — 20-story tall Ferris wheel","🌲 'City in a Forest' — known for its massive tree canopy","🏟️ Stadium video board could fit a jumbo jet inside!"],
 ["👕 Kylian Mbappé — French phenom","🇫🇷 75 caps, 46 goals for France","⚡ Forward for Real Madrid","🏆 World Cup winner at age 19 (2018)!","🌟 Hat-trick in 2022 World Cup final","🎯 Fastest player ever recorded on pitch","🔥 6 Ligue 1 titles with PSG","🌎 Born in Bondy, France","🥇 Won the World Cup Golden Boot in 2022 (8 goals)","⚡ Top speed of 38 km/h — almost as fast as Usain Bolt!","🐢 Nicknamed 'Donatello' (Ninja Turtle) by teammates","🤝 Donated 2018 World Cup earnings to a children's charity"]),
("NRG Stadium","NRG Neo","Houston, TX","stadium-06-houston-nrg.png","number-06-houston-profile.png",
 ...
 ["🚀 City: Houston — Space City! NASA Mission Control HQ","🏟️ Stadium: 72,220 seats, first retractable roof in US","🛸 Space Center Houston — see real rockets and astronaut training","🌮 Most diverse food scene in Texas — 70+ cuisines","🎸 Live music capital of the South","🔥 Fun Fact: First NFL stadium with a retractable roof!","⭐ Hosted Super Bowls XXXVIII + LI + 2017 World Series","🌎 Texas Medical Center — world's largest medical complex","🤠 Houston is the 'Energy Capital of the World'","🍔 The first traditional cheeseburger was created in Texas!","🏗️ Stadium hosts soccer, football, and even huge rodeos","🚇 20 feet below the city is a 7-mile tunnel system!"],
 ["👕 Victor Osimhen — Nigerian superstar","🇳🇬 35 caps, 21 goals for Nigeria","⚡ Striker for Galatasaray","🏆 African Footballer of the Year 2023","🌟 31 goals in Serie A 2022-23 season","🎯 Known for aerial ability + lightning speed","🔥 Led Napoli to first Serie A title in 33 years","🌎 Born in Lagos, Nigeria","🎭 Wears a protective black mask during every match","🦅 3rd Nigerian to ever win African Footballer of the Year","👟 Started career at 'Ultimate Strikers Academy' in Lagos","⚽ Highest-scoring African in Serie A history (2023)"]),
("AT&T Stadium","Titan Tex","Arlington, TX (Dallas)","stadium-07-dallas-titantex.png","number-07-dallas-profile.png",
 ...
 ["🤠 City: Dallas — Texas BBQ, State Fair, Reunion Tower","🏟️ Stadium: 80K+ seats, 160-ft video board (size of a 737!)","🥩 Texas BBQ capital — brisket, ribs, and sausage","📺 3,000+ HD TVs throughout the concourse","🚪 World's largest retractable glass doors","🔥 Fun Fact: Video board is longer than a Boeing 737 airplane!","⭐ 'Jerry World' — named after Cowboys owner Jerry Jones","🌎 Can expand to 105,000 seats for big events","🍹 The Frozen Margarita machine was invented in Dallas!","🎢 Six Flags Over Texas — the first Six Flags theme park","🏟️ Stadium uses enough power to light up a small town!","🎡 Home to the tallest Ferris wheel in North America"],
 ["👕 Son Heung-min — Asia's biggest star","🇰🇷 127 caps, 48 goals for South Korea","⚡ Forward for Tottenham Hotspur","🏆 Premier League Golden Boot 2021-22","🌟 First Asian to win PL Golden Boot ever!","🎯 Puskás Award — 70m solo run goal 2019","🔥 Captain of South Korea since 2022","🌎 Born in Chuncheon, South Korea","🇰🇷 His father was also a pro soccer player and coach","👋 Known for his iconic 'camera' goal celebration","🎖️ Completed military service in South Korea in 2020","🎹 Loves playing the piano and video games for fun"]),
("SoFi Stadium","The Infinity Giant","Inglewood, CA (LA)","stadium-08-lax-sofi.png","number-08-lax-profile.png",
 ...
 ["🎬 City: LA — Hollywood Sign, Venice Beach, Walk of Fame, studios","🏟️ Stadium: 70K+ seats, $5.5B — most expensive stadium ever!","🖥️ Only double-sided 4K video board in the world","🏠 Indoor-outdoor design — ocean breeze flows through","🌟 Hosted Super Bowl LVI + will host 2028 Olympics","🔥 Fun Fact: $5.5 billion — most expensive sports venue ever!","⭐ 3 million square feet — one of largest stadiums globally","🌎 Located in Hollywood Park — 298 acres of entertainment","🎬 Hollywood sign originally said 'HOLLYWOODLAND'","🍦 L.A. is the birthplace of the Hot Fudge Sundae!","🏗️ Stadium roof is held up by 37 earthquake-proof pillars","🔭 Griffith Park — home to the famous L.A. Observatory"],
 ["👕 Cristiano Ronaldo — CR7 legend","🇵🇹 205 caps, 128 goals (all-time top scorer!)","⚡ Forward for Al Nassr FC","🏆 5x Ballon d'Or winner","🌟 Won Euro 2016 with Portugal","🎯 900+ career goals — one of greatest ever","🔥 All-time international top scorer in history","🌎 Born in Funchal, Madeira, Portugal","🏋️ Famous for his strict diet and 5-6 small meals a day","🚫 Has no tattoos so he can donate blood regularly","🏆 Won the Champions League 5 times with two clubs","🛩️ Has an international airport named after him!"]),
("Levi's Stadium","The Silicon Giant","Santa Clara, CA (Bay Area)","stadium-09-bayarea-levis.png","number-09-bayarea-profile.png",
 ...
 ["🌉 City: SF Bay — Golden Gate Bridge (1.7 miles), Silicon Valley","🏟️ Stadium: 68,500 seats, net-zero energy, solar parking","🚋 Cable cars — iconic San Francisco transport since 1873","🧑‍🌾 Faithful Farm — rooftop garden grows veggies for games!","💻 Silicon Valley — tech capital of the world","🔥 Fun Fact: Roof garden grows tomatoes, peppers, herbs for food!","⭐ Super Bowl 50 was hosted here in 2016","🌎 Fog rolls in — 'Karl the Fog' is a local celebrity","🌉 Golden Gate color is officially 'International Orange'","🍪 Fortune cookies were invented in San Francisco!","🏟️ First U.S. stadium to be LEED Gold certified","🦁 S.F. Zoo — home to the first U.S. born koalas"],
 ["👕 Bernardo Silva — midfield maestro","🇵🇹 93 caps, 12 goals for Portugal","⚡ Midfielder for Manchester City","🏆 4x Premier League champion","🌟 Won Champions League with Man City 2023","🎯 Known for incredible ball control + passing","🔥 UEFA Nations League winner 2019","🌎 Born in Lisbon, Portugal","🎾 Huge fan of Roger Federer and loves playing tennis","🐶 Named his French bulldog 'John' after a teammate","🇵🇹 Called 'Bubblegum' because the ball sticks to him","🏆 Won a 'treble' (3 major trophies) with Man City 2023"]),
("Lumen Field","The Roaring Giant","Seattle, WA","stadium-10-seattle-lumen.png","number-10-seattle-profile.png",
 ...
 ["🏔️ City: Seattle — Space Needle (605 ft), coffee capital","🏟️ Stadium: 69,000 seats — LOUDEST stadium in the world!","☕ Starbucks was born in Seattle at Pike Place Market 1971","🌲 Pacific Northwest — stunning forests, mountains, water","🎸 Grunge music birthplace — Nirvana, Pearl Jam, Soundgarden","🔥 Fun Fact: Fans caused measured earthquakes when cheering!","⭐ Horseshoe shape focuses sound like a giant megaphone","🌎 Pike Place Market — famous flying fish since 1907","☕ Seattleites drink more coffee than any other U.S. city","🎡 Seattle Great Wheel — one of the largest in the West","🏢 Smith Tower — once the tallest building in the West","🛳️ Take a ferry across Puget Sound to visit nearby islands"],
 ["👕 Virgil van Dijk — defensive wall","🇳🇱 68 caps, 9 goals for Netherlands","⚡ Defender for Liverpool FC","🏆 UEFA Men's Player of the Year 2019","🌟 Won Champions League with Liverpool 2019","🎯 Known as one of best defenders in history","🔥 Captain of Netherlands national team","🌎 Born in Breda, Netherlands","🧱 Went 65 consecutive games without being dribbled past!","🎤 Worked as a dishwasher before becoming a pro player","🏅 First defender to be a Ballon d'Or finalist since 2006","📏 Stands 6'4\" tall — a giant of the defensive line"]),
("Gillette Stadium","The Lighthouse Giant","Foxborough, MA (Boston)","stadium-11-boston-gillette.png","number-11-boston-profile.png",
 ...
 ["🏛️ City: Boston — Freedom Trail (2.5 miles), Tea Party, Harvard","🏟️ Stadium: 65,878 seats, 22-story lighthouse — iconic beacon!","🦞 Famous for lobster rolls, clam chowder, and baked beans","🏆 Hosted 6 Super Bowls — one of NFL's legendary venues","🎓 Harvard (1636) + MIT — world's top universities","🔥 Fun Fact: 22-story lighthouse is a real working beacon!","⭐ Lighthouse + bridge entrance — like a New England postcard","🌎 Home to Patriots + Revolution — football + soccer","🦆 Boston's Swan Boats have been around since 1877","🏫 First U.S. subway system was built in Boston in 1897","🥧 Boston Cream Pie is actually a cake (State Dessert!)","🏟️ Stadium is surrounded by historic cranberry bogs"],
 ["👕 Gianluigi Donnarumma — giant in goal","🇮🇹 62 caps, 0 goals (goalkeeper!)","⚡ Goalkeeper for Paris Saint-Germain","🏆 Euro 2020 Player of the Tournament!","🌟 Won Euro 2020 with Italy","🎯 Saved 2 penalties in Euro 2020 final shootout","🔥 Debut at AC Milan at age 16 — youngest ever","🌎 Born in Castellammare di Stabia, Italy","🧤 Made his pro debut for AC Milan at only 16 years old","🇮🇹 Replaced the legendary Buffon as Italy's #1 goalie","🏆 Named Player of the Tournament at Euro 2020","🦒 Stands 6'5\" tall — a massive reach in the goal!"]),
]
