...
def strip_cat(t):
    """Strip [CATEGORY] prefix from text. Data is already clean ASCII."""
    return re.sub(r'^\[[^\]]+\]\s*', '', t)
...
("MetLife Stadium","The Silver Giant","New York / NJ","stadium-01-metlife-nyc.png","number-01-metlife-profile.png",
 ...
 ["[ CITY]  Statue of Liberty  Standing tall in the harbor, this iconic lady has welcomed visitors to the New York area for over 100 years!",
  "[ CITY]  Linguistically Diverse  NYC is the most diverse city on Earth, with over 800 different languages spoken by its amazing residents!",
  "[ CITY]  Broadway Stars  The famous theater district hosts 41 professional theaters and draws 12 million excited fans every single year!",
  "[ CITY]  Pizza Capital  With more than 1,600 pizzerias, you are never more than a few blocks away from a world-famous New York slice!",
  "[ STADIUM]  Massive Capacity  With 82,500 seats, this stadium is big enough to hold a whole city of cheering soccer fans!",
  "[ STADIUM]  Silver Louvers  The stadium's unique silver exterior can glow in different colors to match the teams playing on the field!",
  "[ STADIUM]  Steel Giant  It took 40,000 tons of steel to build this stadium, which is the same weight as 8,000 massive African elephants!",
  "[ STADIUM]  The Big Stage  This legendary venue has been chosen to host the 2026 World Cup Final, where the new world champion will be crowned!",
...
("Lincoln Financial Field","The Linc","Philadelphia, PA","stadium-02-philly-linc.png","number-02-philly-profile.png",
 "Vincius Jnior","Brazil","Forward","Real Madrid",30,5,
 ["[ CITY]  Brotherly Love  Philadelphia is known as the 'City of Brotherly Love' and was the first capital of the United States!",
  "[ CITY]  The Liberty Bell  This famous bell with its giant crack is a symbol of American freedom and lives right in the heart of Philly!",
  "[ CITY]  Soft Pretzel City  Philly is world-famous for its delicious soft pretzels and refreshing 'Water Ice' treats that kids love!",
  "[ CITY]  Mural Masterpiece  Philadelphia has more outdoor murals than any other city in the world, turning the streets into a giant art gallery!",
  "[ STADIUM]  Solar Power  The Linc is covered in 11,000 solar panels, which generate enough clean energy to power 1,000 homes!",
  "[ STADIUM]  Wind Turbines  To be even greener, the stadium has 14 wind turbines that spin in the breeze to create electricity!",
  "[ STADIUM]  Eagle Wings  The stadium's architecture features unique 'wing' shapes on the roof to match the Eagles team that plays there!",
  "[ STADIUM]  Historic Turf  Beyond soccer, this field has hosted the famous Army-Navy college football game many times since 1890!",
  "[ WOW]  Rocky Steps  You can run up the 72 stone steps at the Art Museum just like Rocky Balboa did in his famous movies!",
 ...
 ["[ CAREER]  Vini Jr.  Vincius Jnior is a superstar forward from Brazil who uses his incredible skills to dazzle fans around the world!",
  ...
  "[ ACHIEVEMENTS]  Brazil Pride  Vini has represented Brazil over 30 times and even helped them win the Copa Amrica trophy in 2019!",
  ...
  "[ EXTRA]  So Gonalo  Vini was born in So Gonalo, a city near Rio de Janeiro, where he first started dreaming of becoming a soccer star!",
  "[ EXTRA]  Helping Hands  He runs his own charity called the Vini Jr. Institute to help use technology to improve education for kids in Brazil!",
...
("FedExField","The FedEx Giant","Landover, MD (DC)","stadium-03-dc-fedex.png","number-03-dc-profile.png",
 ...
 ["[ CITY]  Capitol Capital  Washington D.C. is the center of the US government and is home to the White House and the beautiful Capitol building!",
  "[ CITY]  Cherry Blossoms  Every spring, the city turns pink when 3,000 cherry trees, a gift from Japan, bloom all at once!",
  "[ CITY]  No Skyscrapers  D.C. has no tall skyscrapers because no building is allowed to be much taller than the street is wide!",
  "[ CITY]  Library of Congress  This amazing building is the largest library in the entire world, with millions of books on its shelves!",
  "[ STADIUM]  Huge Footprint  FedExField is one of the largest stadiums in the NFL, with enough room for 82,000 fans to watch the action!",
  "[ STADIUM]  Parking King  The stadium has over 30,000 parking spaces, making it one of the biggest parking lots in all of sports!",
  "[ STADIUM]  Concert Central  When the game is over, the stadium hosts giant concerts for stars like Beyonc and the Rolling Stones!",
  "[ STADIUM]  Global Concourse  Fans from all over the world gather here to fly their flags and celebrate their favorite teams!",
  ...
  "[ WOW]  Free Museums  All 19 Smithsonian museums in the city are completely free to visit, so you can see dinosaurs and space shuttles for free!",
  ...
  "[ WOW]  Winter Fun  In the winter, the city's Sculpture Garden turns into a giant outdoor ice rink where families go skating!"],
 ["[ CAREER]  England Captain  Harry Kane is the leader of the England national team and one of the best strikers to ever play the game!",
  ...
  "[ ACHIEVEMENTS]  All-Time Scorer  Harry Kane holds the amazing record for scoring the most goals in the history of the England national team!",
...
("Hard Rock Stadium","Hard Rock Hero","Miami Gardens, FL","stadium-04-miami-hardrock.png","number-04-miami-profile.png",
 ...
 ["[ CITY]  Sunshine City  Miami is known for its beautiful beaches and gets about 248 days of bright sunshine every single year!",
  "[ CITY]  Art Deco Style  The South Beach area is famous for its 'Art Deco' buildings, which are painted in bright, beautiful neon colors!",
  "[ CITY]  Nature's Mix  Miami is the only place in the world where both alligators and crocodiles live together in the wild!",
  "[ CITY]  Cruise Capital  The Port of Miami is the busiest cruise ship port in the world, with giant ships leaving for the islands every day!",
  "[ STADIUM]  Shade for All  The stadium has a massive 'open-air' canopy that covers 90% of the seats to keep fans dry and out of the sun!",
  "[ STADIUM]  F1 Race Track  Once a year, the area around the stadium is turned into a high-speed Formula 1 race track for the Miami Grand Prix!",
  "[ STADIUM]  Ship Mast Spires  The four huge white spires at the corners of the stadium are designed to look like the masts of a giant ship!",
  "[ STADIUM]  Tropical Vibe  With its open corners and ocean breezes, watching a game here feels like being at a giant tropical party!",
 ...
 ["[ CAREER]  The GOAT  Many fans believe Lionel Messi is the 'Greatest of All Time' because of his incredible magic with the soccer ball!",
  ...
  "[ EXTRA]  Napkin Contract  He was so good as a child that his first contract with FC Barcelona was written on a paper napkin at a restaurant!"]),
("Mercedes-Benz Stadium","The Benz","Atlanta, GA","stadium-05-atlanta-benz.png","number-05-atlanta-profile.png",
 "Kylian Mbapp","France","Forward","Real Madrid",75,46,
 ["[ CITY]  Busy Skies  Atlanta's airport is the busiest in the entire world, with thousands of planes taking off and landing every single day!",
  "[ CITY]  Forest City  Atlanta is known as the 'City in a Forest' because it has more trees covering it than almost any other major city!",
  "[ CITY]  Coke's Home  The world-famous Coca-Cola drink was invented right here in Atlanta way back in the year 1886!",
  "[ CITY]  The Peach State  Georgia is famous for its peaches, but surprisingly, its biggest and most valuable crop is actually peanuts!",
  "[ STADIUM]  Petal Roof  The stadium's roof is made of 8 giant 'petals' that open and close just like a blooming flower in only 8 minutes!",
  "[ STADIUM]  Halo Board  Inside, there is a giant 360-degree video screen called the 'Halo Board' that is the largest screen in all of sports!",
  "[ STADIUM]  Super Green  This stadium is 'LEED Platinum' certified, which means it is one of the most environmentally friendly buildings ever made!",
  "[ STADIUM]  Fan-Friendly  The stadium is famous for its low food prices, where fans can get hot dogs and popcorn for just a few dollars!",
 ...
 ["[ CAREER]  French Phenom  Kylian Mbapp is a lightning-fast superstar from France who is considered the best young player in the world!",
  ...
  "[ CAREER]  Record Speed  Kylian is one of the fastest players ever recorded, reaching speeds of 38 km/halmost as fast as a car!",
...
("NRG Stadium","NRG Neo","Houston, TX","stadium-06-houston-nrg.png","number-06-houston-profile.png",
 ...
 ["[ CITY]  Space City  Houston is home to NASA's Mission Control, which is why it is famously known around the world as 'Space City!'",
  "[ CITY]  Foodie Heaven  Houston has one of the most diverse food scenes in America, with over 70 different types of global cuisines to try!",
  "[ CITY]  Music Hub  The city is a major center for live music and is the birthplace of many famous singers and superstar performers!",
  "[ CITY]  Energy Capital  Houston is known as the 'Energy Capital of the World' because so many of the world's oil and gas companies are based there!",
  "[ STADIUM]  First of its Kind  NRG Stadium was the very first NFL stadium in the United States to be built with a retractable roof!",
  "[ STADIUM]  Rodeo Ready  Every year, the stadium is filled with dirt and animals for the Houston Livestock Show and Rodeo, the largest in the world!",
  "[ STADIUM]  Soccer History  This field has hosted many huge games, including matches for the Copa Amrica and several Super Bowls!",
  "[ STADIUM]  Massive Space  The stadium can hold over 72,000 fans, and the floor space is large enough to host almost any event imaginable!",
  "[ WOW]  Real Rockets  At Space Center Houston nearby, you can walk inside a real space shuttle and see giant Saturn V rockets!",
  "[ WOW]  Multi-Sport  The stadium is so well-designed that it can switch from a soccer field to a rodeo arena in just a few days!",
...
("AT&T Stadium","Titan Tex","Arlington, TX (Dallas)","stadium-07-dallas-titantex.png","number-07-dallas-profile.png",
 ...
 ["[ CITY]  Cowboy Culture  Dallas is a city where you can see real cowboys, visit the State Fair of Texas, and eat world-class BBQ!",
  "[ CITY]  BBQ Capital  Texas is famous for its slow-cooked BBQ, and Dallas is one of the best places to find delicious brisket and ribs!",
  "[ CITY]  Six Flags  The very first 'Six Flags' theme park was opened right here in the Dallas area over 60 years ago!",
  "[ CITY]  Tallest Wheel  Dallas is home to the 'Texas Star,' which was the tallest Ferris wheel in North America for many years!",
  "[ STADIUM]  Jerry World  This stadium is so big and expensive that people nickname it 'Jerry World' after the owner of the Dallas Cowboys!",
  "[ STADIUM]  Video Giant  The stadium features a massive video board that is 160 feet widethat's actually longer than a Boeing 737 airplane!",
  "[ STADIUM]  Glass Doors  The stadium has the world's largest retractable glass doors, which can open up to let in the fresh Texas air!",
  "[ STADIUM]  Expandable Seats  While it usually holds 80,000 people, the stadium can expand to hold a massive crowd of 105,000 fans!",
  ...
  "[ WOW]  Power Hungry  On a game day, this stadium uses more electricity than an entire small town does in a whole day!",
 ...
 ["[ CAREER]  Asia's Icon  Son Heung-min is the most famous soccer player in Asia and the captain of both the South Korea team and Tottenham!",
  ...
  "[ ACHIEVEMENTS]  Pusks Award  In 2019, he won the Pusks Award for the 'Best Goal of the Year' after a 70-meter solo run where he beat the whole team!",
  ...
  "[ ACHIEVEMENTS]  Military Service  In 2020, Son showed his dedication by completing his mandatory military training in South Korea during his break!",
...
("SoFi Stadium","The Infinity Giant","Inglewood, CA (LA)","stadium-08-lax-sofi.png","number-08-lax-profile.png",
 ...
 ["[ CITY]  Hollywood Magic  Los Angeles is the movie capital of the world, where you can find the Walk of Fame and the famous Hollywood Sign!",
  "[ CITY]  Beach Life  LA has some of the most famous beaches in the world, like Venice Beach and Santa Monica, where people surf all year!",
  "[ CITY]  Landmark Sign  The giant 'HOLLYWOOD' sign on the hill originally said 'HOLLYWOODLAND' when it was first built as an advertisement!",
  "[ CITY]  Sweet Invention  Did you know that the delicious 'Hot Fudge Sundae' ice cream treat was actually invented in Los Angeles?",
  "[ STADIUM]  Most Expensive  SoFi Stadium cost $5.5 billion to build, making it the most expensive and high-tech sports stadium ever made!",
  "[ STADIUM]  Indoor-Outdoor  The stadium has a giant clear roof, but the sides are open to let the cool ocean breezes flow through the seats!",
  "[ STADIUM]  The Infinity Screen  Hanging from the roof is a double-sided 4K video board that is shaped like a giant oval and is larger than the field!",
  "[ STADIUM]  Earthquake Proof  To stay safe, the stadium's massive roof is held up by 37 giant pillars that are designed to withstand earthquakes!",
  ...
  "[ WOW]  Massive Size  The stadium is so big that it covers 3 million square feet, which is enough space to fit many city blocks inside!",
 ...
 ["[ CAREER]  CR7 Legend  Cristiano Ronaldo is one of the greatest soccer players in history and is famous for his 'CR7' brand!",
  ...
  "[ EXTRA]  Super Athlete  He is famous for his incredibly strict diet and for working out in the gym for many hours every single day!",
...
("Levi's Stadium","The Silicon Giant","Santa Clara, CA (Bay Area)","stadium-09-bayarea-levis.png","number-09-bayarea-profile.png",
 ...
 ["[ CITY]  Golden Gate  The San Francisco Bay Area is home to the world-famous Golden Gate Bridge, which is painted a color called 'International Orange!'",
  "[ CITY]  Silicon Valley  This area is the high-tech center of the world, where famous companies like Google, Apple, and Facebook were started!",
  "[ CITY]  Cable Cars  San Francisco is the only city in the world with moving cable cars that people can ride up and down the steep hills!",
  "[ CITY]  Fortune Cookies  Even though people think they are from China, the modern fortune cookie was actually invented in San Francisco!",
  "[ STADIUM]  Smart Stadium  At Levi's Stadium, fans can order food and watch replays right from their phone using a special stadium app!",
  "[ STADIUM]  Rooftop Farm  The stadium has a 'Faithful Farm' on its roof where they grow real tomatoes, peppers, and herbs for the food served inside!",
  "[ STADIUM]  Solar Power  The parking lots are covered with 20,000 solar panels that help create enough clean energy to power the entire stadium!",
  "[ STADIUM]  Net-Zero Energy  On game days, the stadium creates as much energy as it uses, which is amazing for such a big building!",
 ...
 ["[ CAREER]  The Architect  Bernardo Silva is called the 'Architect' because he plans and builds attacks like a brilliant engineer!",
  ...
  "[ CAREER]  Man City Star  Bernardo plays for Manchester City in England, one of the best teams in the world!",
...
("Lumen Field","The Roaring Giant","Seattle, WA","stadium-10-seattle-lumen.png","number-10-seattle-profile.png",
 ...
 ["[ CITY]  Emerald City  Seattle is called the 'Emerald City' because of the evergreen trees and beautiful green forests that surround it!",
  "[ CITY]  Coffee Capital  The world-famous Starbucks coffee company opened its very first store in Seattle's historic Pike Place Market!",
  "[ CITY]  Flying Fish  At Pike Place Market, fish vendors throw giant fish through the air to each other, delighting visitors every day!",
  "[ CITY]  City of Hills  Seattle is built on seven different hills, similar to the famous city of Rome in Italy!",
  "[ STADIUM]  Loudest Stadium  Lumen Field is known as the loudest stadium in the world, and has actually caused earthquakes from cheering!",
  "[ STADIUM]  Sound Focus  The stadium is shaped like a horseshoe, which focuses the crowd's roar onto the field, making it super intense!",
  "[ STADIUM]  Seahawks Home  The stadium is home to the Seattle Seahawks, whose '12th Man' fans are legendary for their noise and passion!",
  "[ STADIUM]  Soccer Ready  The grass field at Lumen Field is specially designed to handle the quick turns and action of FIFA soccer!",
 ...
 ["[ CAREER]  Defensive Wall  Virgil van Dijk is one of the best defenders in the world, known for being almost impossible to get past!",
  ...
  "[ CAREER]  Never Beaten  For an incredible 50 games in a row, nobody was able to dribble past Virgil  a record for a defender!",
...
("Gillette Stadium","The Lighthouse Giant","Foxborough, MA (Boston)","stadium-11-boston-gillette.png","number-11-boston-profile.png",
 ...
 ["[ CITY]  Historic Boston  Boston is one of the oldest cities in America and is where the American Revolution began!",
  "[ CITY]  Freedom Trail  You can follow the Freedom Trail, a 2.5 mile walk that takes you past 16 of the most important historic sites in America!",
  "[ CITY]  Lobster Love  Boston is world-famous for its delicious lobster rolls and creamy clam chowder soup!",
  "[ CITY]  First School  Boston opened the first public school in America way back in 1635, which is still open and teaching kids today!",
  "[ STADIUM]  Lighthouse Icon  Gillette Stadium has a real, working 22-story tall lighthouse that lights up the sky and can be seen from far away!",
  "[ STADIUM]  Super Bowl Central  This stadium has hosted an incredible six Super Bowls, including the epic 2022 championship game!",
  "[ STADIUM]  New England Charm  The stadium has a beautiful bridge modeled after the historic Longfellow Bridge in Boston!",
  "[ STADIUM]  Revolution Home  Besides American football, the stadium is also the home of the New England Revolution soccer team!",
...
# ============================================================
# PAGES 27-29: INTERACTIVE TRACKER PAGES
# ============================================================
...
c.setFillColorRGB(0.5,0.5,0.5)
c.drawString(BLEED+15,BLEED+8,"WORLD CUP 2026 SOUVENIR GUIDEBOOK")
c.drawRightString(PW-BLEED-15,BLEED+8,"Group Stage Tracker")
c.showPage()

# PAGE 28: Knockout Bracket - Simple Bracket Tree
c.setFillColorRGB(1,1,1);c.rect(0,0,PW,PH,fill=1,stroke=0)
c.setFont("Helvetica-Bold",16)
c.setFillColorRGB(0.05,0.05,0.3)
c.drawCentredString(PW/2,PH-M-5,"KNOCKOUT BRACKET")
c.setStrokeColorRGB(0.06,0.06,0.3);c.setLineWidth(1)
c.line(PW/2-120,PH-M-20,PW/2+120,PH-M-20)

# Layout: 8 R32 matches on left, narrowing to Final/Champion on right
lcol=BLEED+10; rcol=PW-BLEED-10; full_w=rcol-lcol
mid_h=PH/2-20

# Round labels
for i,(lbl,xp,w,cl) in enumerate([("R32",0.02,0.14,CARD_COLORS[0]),("R16",0.18,0.12,CARD_COLORS[1]),
    ("QF",0.34,0.10,CARD_COLORS[2]),("SF",0.48,0.10,CARD_COLORS[3]),
    ("FINAL",0.62,0.10,CARD_COLORS[1]),("CHAMP",0.80,0.10,CARD_COLORS[0])]):
    cx=lcol+full_w*xp
    c.setFillColorRGB(*cl)
    c.roundRect(cx,PH-M-38,full_w*w,14,4,fill=1,stroke=0)
    c.setFont("Helvetica-Bold",7);c.setFillColorRGB(1,1,1)
    c.drawCentredString(cx+full_w*w/2,PH-M-35,lbl)

# Draw simple bracket tree - 32 teams on left, converging to final on right
sp=10  # spacing per team line
ml=35  # match line length

# Generate y positions for 32 teams
team_ys=[mid_h+(15.5-i)*sp for i in range(32)]

# Draw team lines on left (R32)
c.setStrokeColorRGB(0.3,0.3,0.3);c.setLineWidth(0.5)
r32_x=lcol+full_w*0.03
for i in range(32):
    y=team_ys[i]
    c.line(r32_x,y,r32_x+ml,y)
    c.setFont("Helvetica-Bold",5);c.setFillColorRGB(0.3,0.3,0.3)
    if i%2==0: c.drawString(r32_x,y-8,f"{i//2+1}.")

# Connect pairs (R32→R16)
r16_x=lcol+full_w*0.19
for pi in range(16):
    y1=team_ys[pi*2]; y2=team_ys[pi*2+1]; ym=(y1+y2)/2
    c.line(r32_x+ml,y1,r32_x+ml,y2)
    c.line(r32_x+ml,ym,r16_x,ym)

# R16 slots
for i in range(8):
    ym=team_ys[i*4+1]
    c.line(r16_x,ym-4,r16_x+ml,ym-4)
    c.line(r16_x,ym+4,r16_x+ml,ym+4)
    c.setFont("Helvetica-Bold",5);c.setFillColorRGB(0.3,0.3,0.3)
    c.drawString(r16_x+2,ym-13,f"{i+1}.")

# R16→QF
qf_x=lcol+full_w*0.35
for pi in range(8):
    y1=team_ys[pi*4+1]-4; y2=team_ys[pi*4+3]+4; ym=(y1+y2)/2
    c.line(r16_x+ml,y1,r16_x+ml,y2)
    c.line(r16_x+ml,ym,qf_x,ym)

# QF slots
for i in range(4):
    ym=team_ys[i*8+3]
    c.line(qf_x,ym-5,qf_x+ml,ym-5)
    c.line(qf_x,ym+5,qf_x+ml,ym+5)
    c.setFont("Helvetica-Bold",5);c.setFillColorRGB(0.3,0.3,0.3)
    c.drawString(qf_x+2,ym-14,f"QF-{i+1}.")

# QF→SF
sf_x=lcol+full_w*0.50
for pi in range(4):
    y1=team_ys[pi*8+3]-5; y2=team_ys[pi*8+7]+5; ym=(y1+y2)/2
    c.line(qf_x+ml,y1,qf_x+ml,y2)
    c.line(qf_x+ml,ym,sf_x,ym)

# SF slots
for i in range(2):
    ym=team_ys[i*16+7]
    c.line(sf_x,ym-6,sf_x+ml,ym-6)
    c.line(sf_x,ym+6,sf_x+ml,ym+6)
    c.setFont("Helvetica-Bold",6);c.setFillColorRGB(0.3,0.3,0.3)
    c.drawString(sf_x+2,ym-15,f"SF-{i+1}.")

# SF→Final
fin_x=lcol+full_w*0.63
y1=team_ys[7]-6; y2=team_ys[23]+6; ym=(y1+y2)/2
c.line(sf_x+ml,y1,sf_x+ml,y2)
c.line(sf_x+ml,ym,fin_x,ym)

# Final match
c.setStrokeColorRGB(0.85,0.25,0.22);c.setLineWidth(1.5)
c.line(fin_x,ym-8,fin_x+ml,ym-8)
c.line(fin_x,ym+8,fin_x+ml,ym+8)
c.setFont("Helvetica-Bold",8);c.setFillColorRGB(0.85,0.25,0.22)
c.drawCentredString(fin_x+ml/2,ym-18,"FINAL")

# Champion
champ_x=lcol+full_w*0.82
c.setStrokeColorRGB(0.85,0.25,0.22);c.setLineWidth(1)
c.line(fin_x+ml,ym,champ_x,ym)
c.setFont("Helvetica-Bold",9);c.setFillColorRGB(0.85,0.2,0.2)
c.drawCentredString(champ_x+ml/2,ym-8,"CHAMPION")
# Trophy
c.setFillColorRGB(0.85,0.2,0.2)
c.circle(champ_x+ml/2,ym+10,6,fill=1,stroke=0)
c.rect(champ_x+ml/2-2,ym+2,4,8,fill=1,stroke=0)
c.rect(champ_x+ml/2-5,ym,10,3,fill=1,stroke=0)
...
c.setStrokeColorRGB(0.06,0.06,0.3);c.setLineWidth(1)
c.line(PW/2-150,ty-14,PW/2+150,ty-14)
ty-=28

# Predictions with colored cards
preds=["> CHAMPION PICK:","* TOP SCORER (GOLDEN BOOT):","> TEAM I AM ROOTING FOR:"]
for pi,label in enumerate(preds):
    cc=CARD_COLORS[pi%len(CARD_COLORS)]
    c.setFillColorRGB(*cc)
    c.roundRect(tx,ty-18,tw,18,4,fill=1,stroke=0)
    c.setFont("Helvetica-Bold",10)
    c.setFillColorRGB(1,1,1)
    c.drawString(tx+4,ty-14,label)
    ty-=20
    c.setStrokeColorRGB(0.5,0.5,0.5);c.setLineWidth(0.5)
    c.line(tx+4,ty,tx+tw-4,ty)
    ty-=18

# Awards section
ty-=4
c.setFillColorRGB(0.06,0.06,0.3)
c.roundRect(tx-4,ty-4,tw+8,18,4,fill=1,stroke=0)
c.setFont("Helvetica-Bold",10)
c.setFillColorRGB(1,1,1)
c.drawString(tx,ty-1,"* TOURNAMENT AWARDS *")
ty-=24

awards=["> BEST MATCH:","* BIGGEST UPSET:","> MOST GOALS IN A GAME:"]
for ai,label in enumerate(awards):
    cc=CARD_COLORS[(ai+2)%len(CARD_COLORS)]
    c.setFillColorRGB(*cc)
    c.roundRect(tx,ty-18,tw,18,4,fill=1,stroke=0)
    c.setFont("Helvetica-Bold",10)
    c.setFillColorRGB(1,1,1)
...
# Journal lines all the way to the bottom
while ty > BLEED + 22:
...
# BACK COVER - Stadium crowd photo
place_full(D+'/back-cover.png')
c.showPage()

c.save()
sz=os.path.getsize(O)/(1024*1024)
print(f"✅ Guidebook saved: {O} ({sz:.1f} MB, 29 pages)")
print(f"   Tracker pages: Groups A-L (1 page), Knockout Bracket, Predictions")
