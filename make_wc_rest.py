...
dc_texts={
    ...
    12:'At half-time, Maya ate a hot dog and looked at the DC monuments visible from the upper deck. "This is the best field trip ever," she said.',
    13:'The second half began with intensity. The US team pressed forward. The FedEx Giant\'s heart glowed brighter with every attack.',
...
atl_texts={
    ...
    11:'At half-time, Sofia explored the stadium. "Did you know this roof can open or close in just 8 minutes?" Dad pointed to the giant Oculus.',
    12:'The second half was intense. Germany controlled possession. Brazil looked dangerous on the counter. Both teams wanted the win.',
...
hou_texts={
    ...
    11:'At half-time, Carlos ate a famous Texas BBQ sandwich. "This is the best food ever!"',
    12:'The second half started fast. Argentina pressed forward. Nigeria defended bravely. Both teams wanted the win.',
